...
1. Clone the repo:
   ```sh
   git clone https://github.com/darshannkumar/react-job-portal.git
   ```
...
Abhishek Rajput - [GitHub](https://github.com/darshannkumar)

Project Link: [https://github.com/darshannkumar/react-job-portal.git](https://github.com/darshannkumar/react-job-portal.git)
